...
# 定义取facter得函数
def gggggget_all_host_facter_message():
...
def get_all_host_facter_message():
    all_host_facter_message={'centos7-docker-ui':{'name':'centos7-docker-ui',
                                              'sn':'VMware-56 4d ba 73 a2 ea 99 4d-62 56 c3 45 ce 77 ff 49',
                                              'public_ip':'200.200.200.222',
                                              'private_ip':'192.168.137.130',
                                              'mac':'00:0c:29:77:ff:49',
                                              'os':'CentOS Linux',
                                              'disk':'21.5 GB',
                                              'mem':'1826 GB',
                                              ...
                                              'name':'centos7-kvm',
                                              'sn':'VMware-56 4d 27 04 cc 50 b6 f5-98 71 d5 a7 19 ff f1 aa',
                                              'public_ip':'',
                                              'private_ip':'192.168.137.131',
                                              'mac':'00:0c:29:ff:f1:aa',
                                              'os':'CentOS Linux',
                                              'disk':'53.7 GB',
                                              'mem':'3778 Mb',
                                              'cpu':'Intel(R) Core(TM) i7-6700 CPU @ 3.40GHz',
